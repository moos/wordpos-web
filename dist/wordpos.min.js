...
function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var i=0;i<t.length;i++){var r=t[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function i(e,i,r){return i&&t(e.prototype,i),r&&t(e,r),e}function r(e,t,i){return t in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}var n=require("../util"),o=n.stopwords,s=n.prepText,a=n.makeStopwordString,u=require("../common"),l=u.is,d=u.get,h=u.getPOS,p=u.lookup,c=u.seek,f=u.lookupPOS,v=require("../rand"),b=v.randX,k=v.rand,y=require("./indexFile"),g=require("./dataFile"),m={n:"noun",v:"verb",a:"adj",r:"adv"},w=function(){function t(i){e(this,t),r(this,"options",{}),r(this,"parse",s),r(this,"seek",c),r(this,"isAdjective",l("a")),r(this,"isAdverb",l("r")),r(this,"isNoun",l("n")),r(this,"isVerb",l("v")),r(this,"getPOS",h),r(this,"getAdjectives",d("isAdjective")),r(this,"getAdverbs",d("isAdverb")),r(this,"getNouns",d("isNoun")),r(this,"getVerbs",d("isVerb")),r(this,"lookup",f),r(this,"lookupAdjective",p("a")),r(this,"lookupAdverb",p("r")),r(this,"lookupNoun",p("n")),r(this,"lookupVerb",p("v")),r(this,"rand",k),r(this,"randAdjective",b("a")),r(this,"randAdverb",b("r")),r(this,"randNoun",b("n")),r(this,"randVerb",b("v")),this.options=Object.assign({},t.defaults,i),this.initFiles(),Array.isArray(this.options.stopwords)&&(this.options.stopwords=a(this.options.stopwords))}return i(t,[{key:"ready",value:function(){return this.loaded||Promise.resolve()}},{key:"initFiles",value:function(){var e=this,t=Object.keys(m),i=function(i){return t.map(function(t,i){return new t(e.options.dictPath,m[i],e.options)}.bind(null,i))},r=function(e){return e.reduce(function(e,i,r){return e[t[r]]=i,e},{})};this.indexFiles=r(i(y)),this.dataFiles=r(i(g)),this.options.preload&&(this.loaded=this.preloadFiles(this.options.preload))}},{key:"getFilesFor",value:function(e){return{index:this.indexFiles[e],data:this.dataFiles[e]}}},{key:"preloadFiles",value:function(e){var t=this._preload(this.indexFiles,e);return this.options.includeData&&(t=Promise.all([].concat(t,this._preload(this.dataFiles,e))).then(function(e){return e.flat()})),t}},{key:"_preload",value:function(e,t){var i,r=function(t){return e[t].load()};return t&&!0!==t?"string"==typeof t&&e[t]?i=r(t):t instanceof Array&&(i=Promise.all(t.map(r))):i=Promise.all(Object.keys(m).map(r)),i||Promise.reject(new RangeError('Unknown POS "'.concat(t,'" for preload.')))}}]),t}();w.defaults={dictPath:"",profile:!1,stopwords:!0,preload:!1,includeData:!1,debug:!1},w.stopwords=o,w.POS=m,module.exports=w;
